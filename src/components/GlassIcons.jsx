    ...
    <div className={`grid gap-[5em] grid-cols-2 md:grid-cols-3 mx-auto py-[3em] overflow-visible ${className || ''}`}>
      {items.map((item, index) => (
        <button
          ...
          // Mengambil fungsi onClick langsung dari struktur objek item portabel
        ...
        >
          {/* Lapisan Belakang (Gradasi Warna) */}
          <span
          ...
          {/* Lapisan Depan (Kaca Backdrop Blur + Ikon) */}
          <span
